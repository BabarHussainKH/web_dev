                            ...
                            <tr>
                              ...
                              <td>
                                <?php
                                    if($std_info['exam_joined']==1){
                                ?>      
                                      <a href="{{ url('user/view_result/'.$std_info['exam_id'])}}" class="btn btn-info btn-sm">View Result</a>
                                <?php      
                                    }
                                ?>
                              </td>
                              ...
                              <td>
                                  ...
                                  ?>
                                    <a href="{{ url('user/join_exam/'.$std_info['exam_id'])}}" class="btn btn-primary btn-sm">Join Exam</a>
                                  
                                  <?php
                                      } else{
                                  ?>      
                                        <a href="{{ url('user/view_answer/'.$std_info['exam_id'])}}" class="btn btn-primary btn-sm">View Answers</a>
