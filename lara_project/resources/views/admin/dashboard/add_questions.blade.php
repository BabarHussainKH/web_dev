                        ...
                        <tbody>
                          @foreach ($questions as $key=>$question)
                              <tr>
                                  ...
                                  <td>
                                      <a href="{{ url('admin/dashboard/update_question/'. $question['id'])}}" class="btn btn-primary btn-sm">Update</a>
                                      <a href="{{ url('admin/dashboard/delete_question/'. $question['id'])}}" class="btn btn-danger btn-sm">Delete</a>
                                  </td>
                              </tr>
                          @endforeach
                        </tbody>
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ url('admin/dashboard//dashboard/add_new_question')}}" class="database_operation">
                <div class="row">
                    <div class="col-sm-12">
