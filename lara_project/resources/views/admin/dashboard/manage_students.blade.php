                          ...
                          @foreach ($students as $key=>$std)
                              <tr>
                                  ...
                                  <td>
                                    ...
                                    ?>
                                          <a href="{{url('admin/dashboard/admin_view_result/'.$std['id'])}}" class="btn btn-info btn-sm">View result</a>
                                    <?php
                                    }
                                    ?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ url('admin/dashboard/add_new_students')}}" class="database_operation">
                <div class="row">
                    <div class="col-sm-12">
