                        ...
                        <tbody>
                           @foreach ($exams as $key=>$exam)
                               <tr>
                                   ...
                                   <td>
                                       <a href="{{ url('admin/dashboard/edit_exam/'.$exam['id'])}}" class="btn btn-info">Edit</a>
                                       <a href="{{ url('admin/dashboard/delete_exam/'.$exam['id'])}}" class="btn btn-danger">Delete</a>
                                       <a href="{{ url('admin/dashboard/add_questions/'.$exam['id'])}}" class="btn btn-primary">Add Question</a>
                                   </td>
                               </tr>
                           @endforeach
                        </tbody>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ url('/admin/dashboard/add_new_exam')}}" class="database_operation">
                <div class="row">
                    <div class="col-sm-12">
